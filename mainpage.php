        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="content-card" onclick="expandBox(this)">
                    <img src="https://source.unsplash.com/random/300x200/?<?php echo urlencode($history_row['title']); ?>" 
                         alt="<?php echo htmlspecialchars($history_row['title']); ?>">
                    <div class="card-body">
    ...
    <div class="mb-5">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4 col-lg-3">
                <div class="content-card" onclick="expandBox(this)">
                    <img src="https://source.unsplash.com/random/300x200/?<?php echo urlencode($row['title']); ?>" 
