...
<head>
    ...
    <style>
        ...
        .plan-card.selected {
            ...
            background-color: rgba(9, 46, 229, 0.1);
        }
        ...
        .payment-method.selected {
            ...
            background-color: rgba(152, 180, 240, 0.1);
        }
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="plan-card" onclick="selectPlan('Monthly')" id="monthlyPlan">
                            ...
                            <p class="">Billed every month</p>
                            <div class="plan-savings" style="visibility: hidden;">Placeholder</div>
                            <div class="plan-savings" style="visibility: hidden;">Placeholder</div>
                            <ul class="small">
